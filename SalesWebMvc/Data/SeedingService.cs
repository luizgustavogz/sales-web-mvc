    ...
    public class SeedingService {
        ...
        public void Seed() {
            if (_context.Department.Any() ||
                ...
                return; // DB has been seeded / DB já foi populado
            }
            ...
            Seller s3 = new Seller(3, "Alex Grey", "akex@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            Seller s4 = new Seller(4, "Matha Red", "martha@gmail.com", new DateTime(1993, 11, 30), 3000.0, d4);
